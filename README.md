...
- Experimental Qwen3.6-35B-A3B text-only adapter: [deployment and limitations](docs/qwen3.6-deployment.md).
  Supports private swarms with unquantized weights and one GPU per server process; full-size GPU validation is pending.
