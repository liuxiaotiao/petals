...
def main():
    ...
    parser.add_argument("--inference_only", action='store_true',
                        help="Serve inference and plain forward passes only: refuse rpc_backward, so no peer can "
                             "run training through this server, and do not start a backward task pool. "
                             "Recommended for models whose training path is unsupported or unvalidated")
